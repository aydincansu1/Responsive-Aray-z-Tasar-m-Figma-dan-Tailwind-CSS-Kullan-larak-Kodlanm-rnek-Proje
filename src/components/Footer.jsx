...
const Footer = () => {
  ...
  return (
    <div className="w-screen flex flex-col justify-center  md:items-center text-white  md:h-[464px] bg-[#0F172A]">
      <div className=" py-0 px-4 md:px-20 w-[393px] h-[1514px]   md:w-[1440px] ">
        {" "}
