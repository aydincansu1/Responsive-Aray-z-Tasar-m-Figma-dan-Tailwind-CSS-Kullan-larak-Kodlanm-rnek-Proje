...
const Basket = () => {
  return (
    <div className=" w-screen flex flex-col justify-center   isolate  text-white md:h-[776px] bg-[#0F172A] border-2 border-blue-200 z-40">
      <div className="w-[393px] md:w-[1440px]   h-[1739px]  py-12 px-4 gap-8  md:gap-20 md:p-20  md:mx-auto   ">
